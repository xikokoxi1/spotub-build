...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String get add_spotify_credentials =>
      'Điền thông tin đăng nhập Spotify của bạn';
  ...
  String get login_if_not_logged_in =>
      'và Đăng nhập/Đăng ký nếu chưa có tài khoản';
  ...
  String get step_3_steps =>
      'Sao chép giá trị của Cookie \"sp_dc\" và \"sp_key\" (hoặc sp_gaid)';
  ...
  String get success_message =>
      'Bây giờ bạn đã đăng nhập thành công bằng tài khoản Spotify của mình. Làm tốt lắm!';
  ...
  String get step_4_steps =>
      'Dán giá trị đã sao chép của Cookie \"sp_dc\" và \"sp_key\" (hoặc sp_gaid) vào các trường tương ứng';
