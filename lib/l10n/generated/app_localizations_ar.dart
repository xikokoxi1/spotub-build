...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get login_if_not_logged_in =>
      'وتسجيل الدخول/الاشتراك إذا لم تقم بتسجيل الدخول';
  ...
  String get success_message =>
      'لقد قمت الآن بتسجيل الدخول بنجاح باستخدام حساب Spotify الخاص بك. عمل جيد يا صديقي!';
