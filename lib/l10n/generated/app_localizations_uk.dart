...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get login_with_spotify =>
      'Увійти за допомогою облікового запису Spotify';
  ...
  String get add_spotify_credentials =>
      'Додайте свої облікові дані Spotify, щоб почати';
  ...
  String get login_if_not_logged_in =>
      'та Увійдіть/Зареєструйтесь, якщо ви не ввійшли';
  ...
  String get success_message =>
      'Тепер ви успішно ввійшли у свій обліковий запис Spotify. Гарна робота, друже!';
