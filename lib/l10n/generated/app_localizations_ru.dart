...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get login_with_spotify =>
      'Войдите с помощью своей учетной записи Spotify';
  ...
  String get add_spotify_credentials =>
      'Добавьте ваши учетные данные Spotify, чтобы начать';
  ...
  String get login_if_not_logged_in =>
      'и войдите или зарегистрируйтесь, если вы не вошли в систему';
  ...
  String get success_message =>
      'Теперь вы успешно вошли в свою учетную запись Spotify. Отличная работа, приятель!';
